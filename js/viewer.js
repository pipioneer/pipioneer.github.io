...
var PDFViewerApplication = {
  ...
  open: function () {
    ...
    _regenerator["default"].mark(function _callee7(file, args) {
      ...
      var workerParameters, key, parameters, apiParameters, _key, value, prop, loadingTask;
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: 'http://localhost:4000/tests/compressed.tracemonkey-pldi-09.pdf',
  ...
  workerSrc: {
    value: 'https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.2.228/pdf.worker.min.js',
    kind: OptionKind.WORKER
  }
};
{
